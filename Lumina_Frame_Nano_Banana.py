...
def main():
    ...
    # (pygame event polling + OpenGL rendering) executes on the main thread.
    # This is required by SDL2 (display setup, event polling, and flips must
    # share one thread — typically the main thread) and by OpenGL (a context
    # is current on one thread at a time). Not Raspberry-Pi-specific.
